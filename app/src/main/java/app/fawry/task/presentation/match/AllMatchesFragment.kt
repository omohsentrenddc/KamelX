...
@AndroidEntryPoint
class AllMatchesFragment : BaseFragment<FragmentAllMatchesBinding>() , ISubmitAction {
  private  val TAG = "SettingsFragment"

  val viewModel: AllMatchesViewModel by viewModels()

  override
  fun getLayoutId() = R.layout.fragment_all_matches
